...
export const DEFAULT_ALCHEMY_API_KEY = "oKxs-03sij-U_N0iOlrSsZFr29-IqbuF";  //TO-DO: Need to remove this hardcoded key

const scaffoldConfig = {
  ethereumEnabled: false,
  // The networks on which your DApp is live
  targetNetworks: [chains.tronNile],  //Used for ReadOnly functions and variables data fetching. TODO: Enable Nile in viem and ethereum-lists
  ...
  targetTronNetwork: tronNile,  //Used for contract deployment and general UI data like explorers, etc.
